...
Created a centralized patch module at [backend/utils/pydantic_v1_patch.py](../src/utils/pydantic_v1_patch.py):
...
- [backend/extractors/feature_extractor.py](../src/extractors/feature_extractor.py)
- [backend/extractors/metadata_extractor.py](../src/extractors/metadata_extractor.py)
- [backend/extractors/chart_analyzer.py](../src/extractors/chart_analyzer.py)
...
1. **New file**: [backend/utils/pydantic_v1_patch.py](../src/utils/pydantic_v1_patch.py) - Centralized monkeypatch
2. **Modified**: [backend/extractors/feature_extractor.py](../src/extractors/feature_extractor.py) - Apply patch before imports
3. **Modified**: [backend/extractors/metadata_extractor.py](../src/extractors/metadata_extractor.py) - Apply patch before imports
4. **Modified**: [backend/extractors/chart_analyzer.py](../src/extractors/chart_analyzer.py) - Apply patch before imports
