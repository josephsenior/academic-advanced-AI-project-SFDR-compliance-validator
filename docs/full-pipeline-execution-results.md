...
**❌ ERROR** - Document requires corrections before publication.
...
└── 2ed58610-24f0-4a24-a731-01f5625ee045/
    ├── consistency_report.json                    # ⭐ Data consistency validation results
...
✅ **Pipeline is fully operational** with both extraction and consistency validation.

❌ **Document has critical errors** - requires correction before approval.

⚠️ **6 warnings** - should be reviewed and addressed if applicable.
